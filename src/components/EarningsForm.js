    ...
    <StyledEarningsForm>
      ...
      <form className="init-form" onSubmit={handleSubmit}>
        ...
        <div className="switch-wrapper pay-type-wrapper" onChange={handleInputChange}>
          ...
          <input type="radio" id="yearly-radio" name="payType" value="yearly" />
          <label htmlFor="hourly-radio" id="hourly-label" className="radio-label">hourly</label>
          <input type="radio" id="hourly-radio" name="payType" value="hourly"/>
        </div>

        <h5>Pay Amount</h5>
        <input type="number" id="pay-amount" className="hourly-input yearly-input" placeholder="$ / yr" name="payAmount" onChange={handleInputChange} value={inputs.payAmount}/>

        <h5>Hours per week</h5>
        <input type="number" id="hrs-per-wk" className="yearly-input" placeholder="hrs / wk" name="hoursPerWeek" onChange={handleInputChange} value={inputs.hoursPerWeek}/>
